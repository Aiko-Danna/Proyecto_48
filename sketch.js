...
function obstacles(){
	if(frameCount % 120 === 0){
		var obst = createSprite(1500, 680, 50, 50);
		obst.velocityX = -5;
...
function premiosGallina(){
	if(frameCount % 100 === 0){
		var maiz = createSprite(1800, random(350, 550), 10, 10);
...
function nubes(){
	if(frameCount % 120 === 0){
		var nube = createSprite(1600, random(50, 180), 50, 50);
		nube.velocityX = -7;
...
function nivel_2(){
	if(frameCount % 60 === 0){
		var obst = createSprite(2500, 640, 50, 50);
		obst.velocityX = -8;
		var rand = Math.round(random(1,4))
		switch(rand){
			case 1: obst.addImage(obs1Img);
...
function premios_2(){
	if(frameCount % 80 === 0){
		var maiz = createSprite(2800, random(350, 550), 10, 10);
		maiz.addImage(maizImg);
		maiz.scale = 0.2;
		maiz.velocityX = -8;
